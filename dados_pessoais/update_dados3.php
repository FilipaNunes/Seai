...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="packages" style="margin-top:75px">
				...
				<div class="w3-text-red"><center>O NIF que introduziu já existe.<center></div>
				...
				<table>
					...
					<tr>
						...
						<tr>
                            ...
                            <td>
                                <input type="text" class="text-input w3-border" placeholder='Morada' id="morada" name="address" value="<?=$user_data1["morada"]?>" style="width:93%" title="A morada apenas deve incluir letras, espaços, números e o caracter º." pattern="([A-z0-9À-ž\sº.]){2,}" required />
                            </td>
                        </tr>
					</table>
				<br>
