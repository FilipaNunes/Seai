				...
				<table>
					...
					<tr>
						...
						<tr>
                            ...
                            <td>
                                <input type="password" class="text-input w3-border" pattern='^(?=.*[A-Z])(?=.*[0-9])(?=.*[a-z]).{8,}$' title='A password deve ter pelo menos 8 caracteres, incluindo obrigatoriamente uma letra maiúscula, uma letra minúscula e um número!' title='A password deve ter entre 6 e 20 caracteres, incluindo letras, números, hífen ou underscore!' placeholder='Insira a sua nova password (opcional)' size="46" autocomplete="off" />
                            </td>
                        </tr>
						<tr>
                            <td>
