...
<div class="w3-container">
  <h2>Inserir despesas do mês:</h2>
    ...
    <input class="w3-input w3-border" name="salarios" type="number" placeholder='Colocar "0" caso a despesa não exista' step="any" required></p>
    <p>
    <label class="w3-text-red"><b>Água/Gás (€)</b></label>
    <input class="w3-input w3-border" name="aguagas" type="number" placeholder='Colocar "0" caso a despesa não exista' step="any" required></p>
    <p>
    <label class="w3-text-red"><b>Energia (€)</b></label>
    <input class="w3-input w3-border" name="energia" type="number" placeholder='Colocar "0" caso a despesa não exista' step="any" required></p>
    <p>
    <label class="w3-text-red"><b>Aluguer (€)</b></label>
    <input class="w3-input w3-border" name="aluguer" type="number" placeholder='Colocar "0" caso a despesa não exista' step="any" required></p>
    <p>
    <label class="w3-text-red"><b>Manutenção (€)</b></label>
    <input class="w3-input w3-border" name="manutencao" type="number" placeholder='Colocar "0" caso a despesa não exista' step="any" required></p>
    <p>
    <label class="w3-text-red"><b>Outras (€)</b></label>
    <input class="w3-input w3-border" name="outras" type="number" placeholder='Colocar "0" caso a despesa não exista' step="any" required></p>
